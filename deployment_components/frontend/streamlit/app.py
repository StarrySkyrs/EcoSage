...
# Page configs
st.set_page_config(
    page_icon='Subject_3.png',
    page_title='Eco Sage v1.0',
    layout='centered',
...
logo_image = Image.open('Subject_3.png')
...
title_col.write("# Eco Sage")

# Add text
st.text('This is a mock-up demo for the Eco Sage Project.')
...
if uploaded_file is not None:
    ...
    if st.button("Process Image"):
        result = call_backend()
        # open json file in path /Users/ameenyarkhan/Code/Hackathon/data.json 
        # with open('/Users/ameenyarkhan/Code/Hackathon/data.json') as f:
        #     result = json.load(f)
        # result = result['result_list']
        # Create a custom layout for displaying images and text side by side
